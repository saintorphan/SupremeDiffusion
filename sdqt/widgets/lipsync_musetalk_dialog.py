"""MuseTalk lip sync dialog — popup from video player context menu."""
...
class LipSyncMuseTalkDialog(QDialog):
    """Modal dialog for lip-syncing a video via MuseTalk."""
    ...
    def __init__(self, source_path: str, state=None, parent=None) -> None:
        ...
        self.setWindowTitle("Lip Sync \u2014 MuseTalk")
    ...
    def _build_ui(self) -> None:
        ...
        s2 = QHBoxLayout()
        s2.setSpacing(6)
        s2.addWidget(QLabel("BBox Shift:"))
        ...
        s2.addWidget(QLabel("Audio Offset:"))
    ...
    def _on_detect(self) -> None:
        ...
        if not models_dir:
            self._detect_status.setText("Face models directory not set in Settings.")
            return
    ...
    def _on_run(self) -> None:
        ...
        import tempfile
        tmp = tempfile.NamedTemporaryFile(suffix=".mp4", delete=False, prefix="mt_")
        tmp.close()
        output = tmp.name
