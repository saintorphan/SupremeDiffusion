...
class LTX2:
    ...
    def generate(
        ...
        **kwargs,
        ...
        # SupremeDiffusionQt hook: allow the caller to supply a fully-built
        # video_conditioning list (positioned/ramped control guide) that bypasses
        # the internal input_frames assembly above. Each entry is the standard
        # (tensor, start_frame, strength) tuple consumed downstream.
        _cc_override = kwargs.get("control_conditioning_override", None)
        if _cc_override is not None:
            video_conditioning = _cc_override
