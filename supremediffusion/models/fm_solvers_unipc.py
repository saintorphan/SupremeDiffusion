# Copied from wan2gp's shared/utils/fm_solvers_unipc.py
# Original source: https://github.com/huggingface/diffusers/blob/v0.31.0/src/diffusers/schedulers/scheduling_unipc_multistep.py
...
class FlowUniPCMultistepScheduler(SchedulerMixin, ConfigMixin):
    """UniPCMultistepScheduler adapted for flow matching (from wan2gp)."""
